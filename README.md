...
Now I am interesed in getting an understanding of how far some of the children have been moved from the United States-Mexico border. Since the latitdue represets how far north and south a location is, I decided to measure how far each detention center is from the border in terms of latitude change. 

I found that the sourthernmost point of the border lies at a latitude of **25.83**. Therefore, I created a variable called *border_latitude* with the value **25.83** that I will use to find the *lat_change_border*.
...
Now I can arrange the borders from furthest to closest that is greater than 15° latitude change of border.
...
As someone who wants to stay informed, I want to also identify the detention centers that hold the largest number of children by ordering the *number_children* in descending order. 
...
According to the data, children have been separated from their parents to detention centers located in many states. I am interested in the state I have visited before, Texas. I will use the variable *chosen_state* and order filter to just see that data set.
